...
<a class="sub_subitem" href="Controller?page=view-article&title=${ a_row.title}&id=${a_row.aid}"><c:out value="${a_row.title}"></c:out></a><br>
</c:forEach>
</c:forEach>
    </c:forEach>
...
<%--<a class="subitem" href="Controller?page=view-article&title=${ row.title}&id=${row.aid}"><c:out value="${ row.title}"></c:out></a><br>--%>
<%--</c:forEach>--%>
