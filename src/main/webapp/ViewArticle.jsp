...
<sql:query var="result3" dataSource="${ db}">
    select * from love_article where prefer=1 and aid="${ aid}";
</sql:query>
...
<sql:query var="result4" dataSource="${ db}">
    select * from love_article where prefer=0 and aid="${aid}";
</sql:query>
...
<div class="div1">
    <table>
        ...
        <tr>
            <td><h1><c:out value="${ title}"> </c:out></h1></td>
        </tr>
        ...
        <c:forEach items="${ result.rows}" var="row">
            ...
            <tr>
                <td class="td2"><c:out value="${ row.authorName}"></c:out></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="td2"><fmt:formatDate value="${row.time}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
            </tr>

            <tr>
                <td class="td1">Author Email</td>
            </tr>
            <tr>
                <td class="td2"><a href="Controller?page=authorarticle&author=${ row.author}" style="color:dodgerblue">
                    <c:set var="string" value="${ fn:length(row.author)}"></c:set> <c:out
                        value="${ fn:substring(row.author, 0, 3)} *** ${ fn:substring(row.author, string-9, string)}"></c:out> </a>
                </td>
            </tr>
...
<div class="div2">
    ...
    <form action="Controller" method="post">
        ...
        <table>
            <tr>
                <td><input type="text" name="aid" value="${aid}" hidden></td>
            </tr>
            <tr>
                <td><input class="input2" type="text" name="comment" required placeholder="write something here"></td>
            </tr>
            <tr>
...
<c:forEach items="${ result2.rows}" var="row">
    <div class="div3">
        <table>
            <tr>
                <td><a> <c:out value="${ row.user}"></c:out> </a></td>
            </tr>
            <tr>
                <td><c:out value="${ row.comment}"></c:out></td>
            </tr>
            <tr>
                <td><p class="time"><fmt:formatDate value="${row.time}" pattern="yyyy-MM-dd HH:mm:ss"/></p></td>
            </tr>
            <tr>
                <td>
