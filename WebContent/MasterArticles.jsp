...
<tr>
<td><a href="AdminController?page=master-view-article&title=${ row.title}"> <c:out value="${ row.title}"></c:out> </a></td>
<td><c:out value="${ row.author}"></c:out></td>
<td><c:out value="${ row.time}"></c:out></td>
<td><a href="AdminController?page=master-delete&title=${ row.title}">delete</a></td>
</tr>
</c:forEach>
</table>
</div>
