...
// master function		
		...
		if(page.equals("master-home"))
		{
			...
			try
			{
				db.insertAdministerRecord(getLocalIp(request), 0, "view page:master-home");
			}
		...
		if(page.equals("master-articles"))
		{
			...
			try
			{
				db.insertAdministerRecord(getLocalIp(request), 0, "view page:master-articles");
			}
		...
		if(page.equals("master-comments"))
		{
			...
			try
			{
				db.insertAdministerRecord(getLocalIp(request), 0, "view page:master-comments");
			}
		...
		if(page.equals("master-authors"))
		{
			...
			try
			{
				db.insertAdministerRecord(getLocalIp(request), 0, "view page:master-authors");
			}
		...
		if(page.equals("master-delete"))
		{
			...
			{
				db.deleteArticle(title);
				db.insertAdministerRecord(getLocalIp(request), 1, "delete the article:" + title + "");
			}
		...
		if(page.equals("master-view-article"))
		{
			...
			try
			{
				db.insertAdministerRecord(getLocalIp(request), 1, "view the article:" + title + "");
			}
		...
		if(page.equals("master-delete-comments"))
		{
			...
			try
			{
				...
				db.insertAdministerRecord(getLocalIp(request), 0, "view page:master-delete-comments");
			}
		...
		if(page.equals("master-block-author"))
		{
			...
			try
			{
				...
				db.insertAdministerRecord(getLocalIp(request), 1, "block the author:" + author + "");
			}
		...
		if(page.equals("master-release-author"))
		{
			...
			try
			{
				...
				db.insertAdministerRecord(getLocalIp(request), 1, "release the author:" + author + "");
			}
