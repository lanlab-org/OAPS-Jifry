...
<form action="Controller" method="post" class="form1">
    ...
    <table class="table1">
        <tr>
            <td><h1>You are in <c:out value="${subject}"></c:out></h1></td>
        </tr>
        <tr>
...
<sql:setDataSource user="wzf" password="wzf"
                   url="jdbc:mysql://47.115.56.157:3306/oo?serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf8"
...
<div>
    <table class="table2">
        ...
        <c:forEach items="${result.rows}" var="row">
            <tr>
                <td><a href="Controller?page=view-article&title=${ row.title}"> <c:out
                        value="${ row.title}"></c:out> </a></td>
